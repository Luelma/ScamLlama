...
struct MediaVerificationView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .alert("Share Media for AI Analysis?", isPresented: $showAPIConsentAlert) {
    ...
    private var infoCardText: String {
        switch viewModel.selectedMediaType {
        case .photo:
            return "Upload a profile photo to check if it was generated by AI. Combines on-device analysis with Reality Defender and Scam.ai deepfake detection."
        case .video:
            return "Upload a video clip to detect AI-generated or deepfaked video content. Uses Reality Defender and Scam.ai deepfake detection. Max 250 MB."
        case .audio:
    ...
    private var infoLabelText: String {
        switch viewModel.selectedMediaType {
        case .photo: return "On-device + Reality Defender + Scam.ai analysis"
        case .video: return "Reality Defender + Scam.ai deepfake detection"
    ...
    private var consentMessage: String {
        ...
        return "To provide enhanced AI detection, your selected \(mediaLabel) will be uploaded to Reality Defender (api.prd.realitydefender.xyz) and Scam.ai (api.scam.ai) for deepfake analysis.\n\nData sent: The \(mediaLabel) file only. No file names, metadata, or personal information are included.\n\nRecipients: Reality Defender, Inc. and Scam.ai — processed under their respective privacy policies."
    }
    ...
    static var transferRepresentation: some TransferRepresentation {
        FileRepresentation(contentType: .movie) { video in
            ...
            let tempURL = FileManager.default.temporaryDirectory
                .appendingPathComponent("scamllama_video_\(UUID().uuidString).\(received.file.pathExtension)")
...
struct AudioDocumentPicker: UIViewControllerRepresentable {
    ...
    class Coordinator: NSObject, UIDocumentPickerDelegate {
        ...
        func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentsAt urls: [URL]) {
            ...
            let tempURL = FileManager.default.temporaryDirectory
                .appendingPathComponent("scamllama_audio_\(UUID().uuidString).\(url.pathExtension)")
