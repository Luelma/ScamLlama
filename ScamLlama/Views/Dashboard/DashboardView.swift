...
struct DashboardView: View {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        ScrollView(.horizontal, showsIndicators: false) {
                            HStack(spacing: 12) {
                                QuickActionCard(
                                    title: "Analyze Chat",
                                    subtitle: "Is this message a scam? 🤔",
                                ...
                                QuickActionCard(
                                    ...
                                    color: Color(red: 0.13, green: 0.55, blue: 0.47)
                                ) { selectedTab = 2 }
                ...
                ToolbarItem(placement: .principal) {
                    HStack(spacing: 6) {
                        ...
                        Text("Scam Llama")
                            ...
                            .foregroundStyle(
                                LinearGradient(
                                    colors: [Color(red: 0.13, green: 0.55, blue: 0.47), Color(red: 0.12, green: 0.22, blue: 0.42)],
                                    startPoint: .leading,
                                    endPoint: .trailing
                                )
                            )
    ...
    private var statsSection: some View {
        VStack(spacing: 16) {
            ...
            HStack(spacing: 24) {
                StatPill(value: "\(totalScans)", label: "Scans", color: .teal)
                StatPill(value: "\(highRiskCount)", label: "High Risk", color: highRiskCount > 0 ? .red : .green)
                StatPill(value: "\(photoChecks.count)", label: "Media", color: .teal)
            }
        }
        .padding()
        ...
        .background(
            LinearGradient(
                colors: [Color.teal.opacity(0.08), Color(red: 0.12, green: 0.22, blue: 0.42).opacity(0.05)],
    ...
    private var heroSection: some View {
        VStack(spacing: 14) {
            ...
            Text("Analyze messages, verify photos, and spot red flags before you lose money.")
                .font(.subheadline)
        ...
        .background(
            LinearGradient(
                colors: [Color.teal.opacity(0.08), Color(red: 0.12, green: 0.22, blue: 0.42).opacity(0.06)],
                startPoint: .topLeading,
                endPoint: .bottomTrailing
            )
        )
    ...
    private var tipCard: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Americans lost over $10 billion to scams in 2023. If someone you don't know is asking for money, gift cards, or crypto — it's almost certainly a scam.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
