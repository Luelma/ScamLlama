...
struct ChecklistResultView: View {
    ...
    private var recommendationText: String {
        ...
        case .critical:
            return "This situation shows strong indicators of a romance scam. Stop all financial transactions immediately. Do not send money, gift cards, or crypto. Report this person to the platform and consider contacting the FTC at reportfraud.ftc.gov."
        }
    }
}
